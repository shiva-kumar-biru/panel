...
# button_column1 = pn.Column(button_loadcal, align="center", visible=False)
# button_column2 = pn.Column(button_rms, align="center", visible=False)
# button_column3 = pn.Column(button_activeload, align="center", visible=False)
